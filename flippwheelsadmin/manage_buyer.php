...
<head>
    ...
    <title>Admin- manage Buyers</title>
</head>
        ...
        <div class="admin-content">
            <div class="content">
                ...
                <table>
                    ...
                    <?php
                        include "dbconn.php";
                        $sql = mysqli_query($con, "SELECT * FROM `users` WHERE `type`='BUYER'");
                        ...
                        if(mysqli_num_rows($sql)>0){
                            while($data = mysqli_fetch_assoc($sql)){?>
                                ...
                                <td><a href="manage_buyer.php?del=<?php echo $data["id"];?>" onclick="return confirm('Are you sure?');" class="delete">delete</a></td>
                            </tr>
                            <?php
                                }
                        } ?>
