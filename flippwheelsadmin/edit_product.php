<?php
    ...
    $target = "C:/xampp/htdocs/flipwheels/uploads/".basename($_FILES['Image']['name']);
    ...
    $sql = "UPDATE `products` SET `name`='$nam',`registration_number`='$num',`description`='$desc',`price`='$price',`photo`='$image',`negotiable`='$nego',`makeyear`='$myear',`color`='$color',`kmdriven`='$driven',`fuel`='$fuel',`engineincc`='$cc',`productused`='$puse',`delivery`='$del',`type`='$type',`seller_id`='$s_id',`posted_date`='$pdate',`status`='$stat' WHERE id='$id'";
